...
public class KafkaConfig {
    ...
    CommonErrorHandler errorHandler() {
        CommonContainerStoppingErrorHandler cesh = new CommonContainerStoppingErrorHandler();
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler((rec, ex) -> {
            cesh.handleRemaining(ex, Collections.singletonList(rec), consumer2.get(), container2.get());
        }, generateBackOff()) {
            @Override
